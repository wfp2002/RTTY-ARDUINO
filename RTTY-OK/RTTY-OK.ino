...
OBS: Para receber com minimodem no linux
sudo arecord -f S16_LE -r 48000 -Dplughw:0 - | minimodem -r rtty --mark 1445 --space 1275 --stopbit 1.5 -f -

Ligar no pino terra do P2 o ultimo o pino 13 GND do arduino
E no outro pino positivo (Ponta) do P2 no pino 4 do arduino com um resisitor de 10K
...
#define FSK_OUT  13                      // TTL LEVEL pin OUTPUT (LED VERDE)
#define PTT      12                      // PTT pin OUTPUT (LED VERMELHO)
